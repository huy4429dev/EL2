...
const CertificatePage = () => {
    ...
    const handleDelete = async (id) => {
        try {
            ...
            message.success("Xoá Chứng chỉ thành công");
    ...
    return (
        <div>
            <Breadcrumb items={["Chứng chỉ"]}>
                <Space>
                    <Button
                        onClick={() => navigate("/admin/certificate/new")}
                        className="ml-auto"
                        type="primary"
                    >
                        Thêm Chứng chỉ
            ...
            >
                <Table
                    footer={() => `Tổng số Chứng chỉ ${pagination.total}`}
                            ...
                            render: (text, record, index) => {
                                return (
                                    <div key={index}>
                                        <Link
                                            className="mr-2"
                                            to={`/admin/certificate/${record.id}`}
                                        >
                                            <EditFilled />
                                        </Link>
                                        <Popconfirm
