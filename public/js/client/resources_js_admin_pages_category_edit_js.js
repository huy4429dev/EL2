"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_admin_pages_category_edit_js"],{

/***/ "./resources/js/admin/pages/category/edit.js":
/*!***************************************************!*\
  !*** ./resources/js/admin/pages/category/edit.js ***!
  \***************************************************/
...
var UpdateCategoryPage = function UpdateCategoryPage() {
  ...
  var _useQuery = (0,react_query__WEBPACK_IMPORTED_MODULE_2__.useQuery)(['category', [id]], /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return axios.get("/api/admin/category/" + id);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return axios.put("/api/admin/category/" + id, values);

            case 3:
              antd__WEBPACK_IMPORTED_MODULE_5__["default"].success("Chỉnh sửa danh mục thành công");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (UpdateCategoryPage);
